...
$(document).ready(function()
     {  
       // TODO Create a var called usedArray of type Array with declared size for the used bingo
       //      numbers s generating the card 
         var usedArray = new Array(76).fill(false);

       // TODO Create a var called baseArray of type Array initialized with the provided data set
        ...
        //      This function fills the bingo card
         function fillCard(i) {
            ...
            //      has not been used  
             if (!usedArray[number]) 
             {
                // the jQuery updates the HTML tag element with id "square#"
